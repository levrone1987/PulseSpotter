...
PIPELINE_PARAMS = {
    ...
    "tagesschau": {
        ...
        "scrape_patterns": {
            "title": {
                "pattern": """//main[contains(@class, 'content-wrapper')]//div[@class='seitenkopf__title']//h1[@class='seitenkopf__headline']//span[@class='seitenkopf__headline--text']//text()""",
            },
            "description": {
                "pattern": """//main[contains(@class, 'content-wrapper')]//p[contains(@class, 'textabsatz')]//strong//text()""",
            },
            "raw_date": {
                "pattern": """//main[contains(@class, 'content-wrapper')]//div[@class='seitenkopf__title']//p[@class='metatextline']//text()""",
            },
            "parsed_date": {
                "pattern": """//main[contains(@class, 'content-wrapper')]//div[@class='seitenkopf__title']//p[@class='metatextline']//text()""",
                "parse_func": parse_date,
            ...
            "paragraphs": {
                "pattern": """//main[contains(@class, 'content-wrapper')]//p[contains(@class, 'textabsatz')]//text() | //main[contains(@class, 'content-wrapper')]//div[contains(@class, 'columns')]//h2[@class='meldung__subhead']//text()""",
                "extract_all": True,
            },
        },
        "blacklisted_urls": [],
    ...
    "tagesspiegel": {
        ...
        "site_elements_patterns": {
            "articles_pattern": """//div[@id='page-container']//main[@id='main-content']//section//article//div//a/@href""",
            "paginator_pattern": """//div[@id='page-container']//main[@id='main-content']//nav""",
            "active_page_pattern": """//div[@id='page-container']//main[@id='main-content']//nav//li//a[@aria-current='page']/parent::li""",
            "next_page_pattern": """//div[@id='page-container']//main[@id='main-content']//nav//li//a[@aria-current='page']/parent::li/following-sibling::li[1]""",
        },
        "scraper_request_params": {
            "premium_proxy": "true",
            "proxy_country": "de",
        ...
        "scrape_patterns": {
            "title": {
                "pattern": """//main[@id='main-content']//article//header//h1[contains(@class, 'tspBRkp')]/text()""",
                "extract_all": True,
                "parse_func": string_join,
            },
            "description": {
                "pattern": """//main[@id='main-content']//article//header//p[contains(@class, 'tspCaa')]/text()""",
                "extract_all": True,
                "parse_func": string_join,
            },
            "raw_date": {
